        ...
        <div className={styles.grid}>
          ...
          <div className={styles.brandCol}>
            ...
            <div className={styles.socials}>
              ...
              <a href="https://www.instagram.com/gammaluceylon?igsh=bm5sZjltOXV3dndu" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className={styles.socialLink} id="footer-instagram">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
